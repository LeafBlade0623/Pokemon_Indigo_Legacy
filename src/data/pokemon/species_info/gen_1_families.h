...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_SLOWBRO}
                                ...
                                {EVO_LEVEL, 0, SPECIES_SLOWKING, CONDITIONS({IF_HOLD_ITEM, ITEM_KINGS_ROCK})}
                            #endif
                            ),
    },
    ...
    [SPECIES_SLOWPOKE_GALAR] =
    {
        ...
        .formSpeciesIdTable = sSlowpokeFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_SLOWBRO_GALAR, CONDITIONS ({IF_HOLD_ITEM, ITEM_GALARICA_CUFF})}
                            #if P_GEN_2_CROSS_EVOS
                                ,{EVO_LEVEL, 0, SPECIES_SLOWKING_GALAR, CONDITIONS ({IF_HOLD_ITEM, ITEM_GALARICA_WREATH})}
                            #endif
                            ),
    },
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .evolutions = EVOLUTION(
                            ...
                            #endif
                            #if P_GEN_8_CROSS_EVOS
                                {EVO_TRADE, 0, SPECIES_KLEAVOR, CONDITIONS({IF_HOLD_ITEM, ITEM_BLACK_AUGURITE})},
                                {EVO_LEVEL, 0, SPECIES_KLEAVOR, CONDITIONS({IF_HOLD_ITEM, ITEM_BLACK_AUGURITE})}
                            #endif
                            ),
    #endif
    },
